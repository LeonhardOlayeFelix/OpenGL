...
scene::BlendingScene::BlendingScene()
{
	...
	m_GrassTexture = Texture("res/textures/Grass.png");
	m_WindowTexture = Texture("res/textures/window.png");
}
...
void scene::BlendingScene::DoPreviousInit()
{
	...
	m_BlockShader = ShaderProgram("res/shaders/BlendingSceneShader.shader");
